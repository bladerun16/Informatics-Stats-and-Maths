...
#' @return The vector of indexes where the series value the minimum which 
#'         is not less than the double
#'         of the value in the previous returned index; the first returned index is the
#'         one where the first value of r is doubled
# Uses
# - ldp - the last doubling point found, initialised to 1
# Algorithm
# - set ldp to 1 
