...
#
# algo:
# - initialize x as an empty numeric vector
# - use guess as first value to check, storing it in first position of x
# - repeat max_loop times
#   - if the absolute value of the function in x is less than the tolerance
